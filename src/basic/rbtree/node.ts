...
class NilNode implements INode<unknown, unknown> {
    toString() { return '·' }
    _details() { return '(·)' }
    ...
    constructor() {
        this.__key = Symbol('nilNode.key')
        this.__value = Symbol('nilNode.value')
        this.__parent = this.__left = this.__right = this
    }

    get nil(): boolean { return true; }
    get ok(): boolean { return false; }
    entry(): [unknown, unknown] {
        return [this.key, this.value];
    }
    // left: INode<unknown, unknown>;
    // parent: INode<unknown, unknown>;
    // right: INode<unknown, unknown>;

    /** @internal */ readonly __key: unknown
    /** @internal */ __value: unknown
    /** @internal */ __parent: Node<unknown, unknown>;
    /** @internal */ __left: Node<unknown, unknown>;
    /** @internal */ __right: Node<unknown, unknown>;
    /** @internal */ __black: boolean = true;
    get key(): unknown { return this.__key }

    /** The value of the entry which the Node represents, can be mutated */
    get value(): unknown { return this.__value }
    set value(value: unknown) { this.__value = value }
    ...
    /** @internal */ set left(value: Node<unknown, unknown>) { this.__left = value }
    /** @internal */ get parent() { return this.__parent }
    /** @internal */ set parent(value: Node<unknown, unknown>) { this.__parent = value }
    /** @internal */ get right() { return this.__right }
    /** @internal */ set right(value: Node<unknown, unknown>) { this.__right = value }
}


// Nust be called only once because we should have only one nil Node!
function _nilNode(): Node<any, any> {
    return Object.freeze(new NilNode())
}
