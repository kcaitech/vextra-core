...
test("path1", () => {
    const width = 118;
    const height = 114;
    const pathstr1 = "M84.5 44C103.002 44 118 58.9985 118 77.5 L 118 80.5C118 99.0015 103.002 114 84.5 114 L 84.5 114C65.9985 114 51 99.0015 51 80.5 L 51 77.5C51 58.9985 65.9985 44 84.5 44Z";
    const pathstr2 = "M41 0 L 45 0C67.6437 0 86 18.3563 86 41 L 86 41C86 63.6437 67.6437 82 45 82 L 41 82C18.3563 82 0 63.6437 0 41 L 0 41C0 18.3563 18.3563 0 41 0Z"
