...
import { v4 } from "uuid";
import { get_nearest_border_point } from "../data/utils";
...
export class ContactLineModifier {
    ...
    constructor(repo: CoopRepository, pageView: PageView, connection: ContactShape) {
        this.repo = repo;
    ...
    /* 简化已有路径，让其只剩下起始两个端点 */
    simplify(visiblePoints: CurvePoint[]) {
