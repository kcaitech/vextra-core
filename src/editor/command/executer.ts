...
import { BORDER_ATTR_ID, BORDER_ID, FILLS_ATTR_ID, FILLS_ID, PAGE_ATTR_ID, POINTS_ATTR_ID, POINTS_ID, SHADOW_ID, SHAPE_ATTR_ID, TEXT_ATTR_ID, TABLE_ATTR_ID } from "./consts";
