...
import { ShapeType, CurvePoint, ShapeFrame, BoolOp, ExportOptions, ResizeType, PathSegment, OverrideType } from "./baseclasses"
...
export interface OverridesGetter {
    getOverrid(id: string): Shape | undefined;
}
...
export class SymbolRefShape extends Shape implements classes.SymbolRefShape, OverridesGetter {
    ...
    addOverrid(id: string, attr: OverrideType, value: any) {
        ...
        if (override.overrides.indexOf(attr) < 0) {
            override.overrides.push(attr);
        }
